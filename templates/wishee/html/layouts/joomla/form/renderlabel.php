...
if (!empty($description))
{
	if ($text && $text != $description)
	{
		...
		$classes[] = 'has-top top';
		$title     = ' title="' . htmlspecialchars($description) . '"';
...
?>
<label id="<?php echo $id; ?>" for="<?php echo $for; ?>" <?php echo $position; ?>>
	<span data-tooltip aria-haspopup="true" data-disable-hover="false" tabindex="2" class="<?php echo implode(' ', $classes); ?>"<?php echo $title; ?>>
